...
export default function Privacy() {
  return (
    <div className="max-w-4xl mx-auto p-6 md:my-12">
      <div className="space-y-4 mb-12">
        <Link href="/" className="flex flex-col items-center space-y-4">
          ...
          <div className="text-2xl font-bold">WebUntis Sync</div>
        </Link>
        <div>
          This is a <b>German service</b> regulated by the German data
          protection laws. The following <b>privacy policy</b> outlines how we
          handle your personal data by being <b>DSGVO compliant</b>. An English
          version of this privacy policy isn't available yet, but may be added
          in the future. We are sorry for possible inconveniences!
        </div>
      </div>
      <div className="prose">
        ...
        <p>
          ...
          in der Konfigurationsoberfläche eingeben.
        </p>
        <p>
        ...
        <p>
          ...
          Website Vertr&auml;ge geschlossen oder angebahnt werden, werden die
        ...
        <p>Nikolas Beyer</p>
        <p>
          Telefon: +49 176 34537094
          <br />
          E-Mail: webuntis@nikogenia.de
        </p>
        <p>
        ...
        <p>
          Da unser Dienst keine kommerziellen Zwecke verfolgt, wurde auf die
          Angabe eines vollständigen Impressums mit Anschrift verzichtet. Wir
          bitten um Ihr Verständnis, dass wir dies aus Privatsphäregründen nicht
          tun können.
        </p>
        <h3>Speicherdauer</h3>
        <p>
        ...
        <p>
          ...
          &Uuml;bertragung vertraulicher Inhalte, wie zum Beispiel Anmeldedaten
          oder Kalenderinformationen, die Sie an uns als Seitenbetreiber senden,
          eine SSL- bzw. TLS-Verschl&uuml;sselung. Eine verschl&uuml;sselte
        ...
        <p>
          Bei der Registrierung und Anmeldung auf unserer Website werden
          personenbezogene Daten wie Name, E-Mail-Adresse und Passwort erhoben.
          Diese Daten sind notwendig, um Ihnen Zugang zu unseren Diensten zu
          gewähren und Ihre Identität zu verifizieren. Die Eingabe dieser Daten
          erfolgt freiwillig, jedoch ist die Nutzung bestimmter Funktionen ohne
          diese Angaben nicht möglich. Ihre Daten werden ausschließlich zur
          Bereitstellung der Dienste verwendet und nicht an Dritte
          weitergegeben, es sei denn, dies ist gesetzlich vorgeschrieben oder
          zur Vertragserfüllung erforderlich.
        </p>
        <h3>Sichere Speicherung von Anmeldedaten</h3>
        <p>
          Ihre Anmeldedaten werden unter Anwendung modernster
          Sicherheitsstandards verarbeitet. Passwörter werden vor der
          Speicherung sicher gehasht, sodass sie nicht im Klartext vorliegen.
          Die Hashing-Methoden entsprechen den aktuellen Empfehlungen der
          IT-Sicherheitsbranche, um maximale Sicherheit zu gewährleisten.
          Darüber hinaus werden sensible Daten wie Anmeldedaten für externe
          Dienste verschlüsselt gespeichert. Diese Daten verlassen unsere Server
          niemals unverschlüsselt und werden ausschließlich im Rahmen der
          technischen Ziele zur Authentifizierung bei externen Diensten wie
          WebUntis und Google Calendar verwendet.
        </p>
        <h3>Externe Dienste: WebUntis und Google Calendar</h3>
        <p>
          Für die Nutzung der WebUntis API und Google Calendar
          OAuth2-Authentifizierung werden Ihre Anmeldedaten verschlüsselt
          übertragen. Wir speichern keine Kalendardaten auf unseren Servern.
          Stattdessen erfolgt die Übermittlung dieser Daten direkt von einem
          Dienst zum anderen, ohne dass sie dauerhaft bei uns gespeichert
          werden. Die Verarbeitung Ihrer Daten erfolgt ausschließlich im Rahmen
          der technischen Ziele, wie der Synchronisierung von Kalendern, und
          unter strikter Einhaltung der DSGVO. Wir stellen sicher, dass alle
          Datenübertragungen sicher und verschlüsselt erfolgen, um Ihre
          Privatsphäre zu schützen.
        </p>
        <p>
          Im Rahmen der Google Calendar OAuth2-Authentifizierung werden nur die
          Berechtigungen abgefragt, die erforderlich sind, um einen neuen
          Kalender zu erstellen und Events diesem Kalender hinzuzufügen. Wir
          haben keinen Zugriff auf bestehende oder persönliche Kalenderdaten,
          die außerhalb dieser spezifischen Berechtigungen liegen.
        </p>
        <h3>Rechtliche Hinweise</h3>
        <p>
          Wir verpflichten uns, alle personenbezogenen Daten gemäß den geltenden
          Datenschutzgesetzen zu verarbeiten. Dies umfasst die sichere
          Speicherung, Verarbeitung und Übertragung Ihrer Daten sowie die
          Einhaltung der Rechte der betroffenen Personen gemäß DSGVO. Sie haben
          das Recht, jederzeit Auskunft über die Verarbeitung Ihrer Daten zu
          erhalten, diese zu berichtigen oder löschen zu lassen, sowie die
          Einschränkung der Verarbeitung zu verlangen. Darüber hinaus können Sie
          Ihre Einwilligung zur Datenverarbeitung jederzeit widerrufen. Sollten
          Sie Fragen oder Anliegen bezüglich Ihrer Daten haben, stehen wir Ihnen

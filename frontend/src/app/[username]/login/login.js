    ...
    <div className="flex h-svh items-center justify-center bg-gray-50 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-semibold">WebUntis Sync</CardTitle>
          <CardDescription className="text-sm mb-4">
            by Nikogenia
          </CardDescription>
          <CardDescription className="text-lg">
            {fullname ? `Welcome${setup ? '' : ' back'}, ${fullname}!` : "Loading ..."}
          </CardDescription>
        </CardHeader>
        <CardContent>
          {error && (
          ...
          <form onSubmit={setup ? handleSetupSubmit : handleLoginSubmit} className='space-y-6'>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    placeholder={setup ? "Enter new password" : "Enter your password"}
            ...
            <Button className="w-full cursor-pointer" type="submit" disabled={!username || isLoading}>
              {setup ? (isLoading ? "Registering ..." : "Register") : (isLoading ? "Logging in ..." : "Login")}
            </Button>
          </form>
        </CardContent>
      </Card>
